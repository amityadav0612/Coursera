...
const cardData = [
  { id: 1, title: 'Fullstack', image: '/images/generativeAi.png', description: 'Generative Ai' },
  { id: 2, title: 'Web development', image: '/images/fullstack.png', description: 'Web development, projects '},
  { id: 3, title: 'Devops', image: '/images/devops.png', description: 'complete devops bootcamp' },
  { id: 4, title: 'Web3', image: '/images/web3.png', description: 'complete solona development ' }
];
      ...
      >
        {duplicatedCardData.map((card, index) => (
          ...
          >
            ...
            <p className="text-sm text-gray-400 text-center">{card.description}</p>
